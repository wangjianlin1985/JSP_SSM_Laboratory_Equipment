...
public class Info
{
    ...
    public static HashMap getUser(final HttpServletRequest request) {
        final HashMap map = (HashMap)((request.getSession().getAttribute("admin") == null) ? request.getSession().getAttribute("user") : request.getSession().getAttribute("admin"));
        return map;
    }
    ...
    public static String getselect(final String name, final String tablename, final String zdname) {
        final String select = "<select name=\"" + name + "\" id=\"" + name + "\" >";
        return select;
    }
    ...
    public static String getFileUpInfo() {
        String jscode = "";
        jscode = String.valueOf(jscode) + "<script src=/pianotrainwebstie/js/popup.js></script>";
    ...
    public static String tform(final HashMap map) {
        String jscode = "";
        try {
            ...
            while (it.hasNext()) {
                ...
                if (!str1.equals("content")) {
                    ...
                    jscode = String.valueOf(jscode) + " for(var i=0;i<radios.length;i++)\n";
                    jscode = String.valueOf(jscode) + " {\n";
                    jscode = String.valueOf(jscode) + " if(\"" + str2 + "\".indexOf(radios[i].value)>-1)\n";
                    jscode = String.valueOf(jscode) + " {\n";
                    jscode = String.valueOf(jscode) + " radios[i].checked=\"checked\";\n";
                    if (str2.indexOf(" - ") > -1) {
                        String[] split;
                    ...
                    jscode = String.valueOf(jscode) + " f1." + str1 + ".value=\"" + str2 + "\";\n";
                    jscode = String.valueOf(jscode) + " }\n";
                    jscode = String.valueOf(jscode) + " }else{\n";
                    jscode = String.valueOf(jscode) + " if(f1." + str1 + ")\n";
                    jscode = String.valueOf(jscode) + "{\n";
                    jscode = String.valueOf(jscode) + "f1." + str1 + ".value=\"" + str2 + "\";\n";
                    jscode = String.valueOf(jscode) + "}\n";
                    jscode = String.valueOf(jscode) + "}\n";
                    ...
                    jscode = String.valueOf(jscode) + "{\n";
                    jscode = String.valueOf(jscode) + "document.getElementById(\"txt\").src=\"/pianotrainwebstie/upfile/" + map.get("filename") + "\";\n";
                    jscode = String.valueOf(jscode) + "}\n";
                    jscode = String.valueOf(jscode) + "if(document.getElementById(\"txt2\"))\n";
                    jscode = String.valueOf(jscode) + "{\n";
                    jscode = String.valueOf(jscode) + "document.getElementById(\"txt2\").src=\"/pianotrainwebstie/upfile/" + map.get("filename2") + "\";\n";
                    jscode = String.valueOf(jscode) + "}\n";
                    jscode = String.valueOf(jscode) + "if(document.getElementById(\"txt3\"))\n";
                    jscode = String.valueOf(jscode) + "{\n";
                    jscode = String.valueOf(jscode) + "document.getElementById(\"txt3\").src=\"/pianotrainwebstie/upfile/" + map.get("filename3") + "\";\n";
                    jscode = String.valueOf(jscode) + "}\n";
                    jscode = String.valueOf(jscode) + "if(document.getElementById(\"txt4\"))\n";
                    jscode = String.valueOf(jscode) + "{\n";
                    jscode = String.valueOf(jscode) + "document.getElementById(\"txt4\").src=\"/pianotrainwebstie/upfile/" + map.get("filename4") + "\";\n";
                    jscode = String.valueOf(jscode) + "}\n";
                    jscode = String.valueOf(jscode) + "if(document.getElementById(\"txt5\"))\n";
                    jscode = String.valueOf(jscode) + "{\n";
                    jscode = String.valueOf(jscode) + "document.getElementById(\"txt5\").src=\"/pianotrainwebstie/upfile/" + map.get("filename5") + "\";\n";
                    jscode = String.valueOf(jscode) + "}\n";
                }
            }
            jscode = String.valueOf(jscode) + "}\n";
    ...
    public static String getImgUpInfo(final int height) {
        String jscode = "";
        jscode = String.valueOf(jscode) + "<img style=\"cursor: hand\" onclick=\"uploadimg()\" src=\"/pianotrainwebstie/js/nopic.jpg\" id=txt height=\"" + height + "\"/>";
        jscode = String.valueOf(jscode) + "<input type=hidden name=\"filename\" id=\"filename\" value=\"\" />";
        jscode = String.valueOf(jscode) + "<script type=\"text/javascript\"  src=\"/pianotrainwebstie/js/popups.js\"></script>";
        return jscode;
    }
    
    public static String getImgUpInfo2(final int height) {
        String jscode = "";
        jscode = String.valueOf(jscode) + "<img style=\"cursor: hand\" onclick=\"uploadimg2()\" src=\"/pianotrainwebstie/js/nopic.jpg\" id=txt2 height=\"" + height + "\"/>";
        jscode = String.valueOf(jscode) + "<input type=hidden name=\"filename2\" id=\"filename2\" value=\"\" />";
        jscode = String.valueOf(jscode) + "<script type=\"text/javascript\"  src=\"/pianotrainwebstie/js/popup.js\"></script>";
        return jscode;
    }
    
    public static String getImgUpInfo3(final int height) {
        String jscode = "";
        jscode = String.valueOf(jscode) + "<img style=\"cursor: hand\" onclick=\"uploadimg3()\" src=\"/pianotrainwebstie/js/nopic.jpg\" id=txt3 height=\"" + height + "\"/>";
    ...
    public static String getImgUpInfo4(final int height) {
        String jscode = "";
        jscode = String.valueOf(jscode) + "<img style=\"cursor: hand\" onclick=\"uploadimg4()\" src=\"/pianotrainwebstie/js/nopic.jpg\" id=txt4 height=\"" + height + "\"/>";
    ...
    public static String getImgUpInfo5(final int height) {
        String jscode = "";
        jscode = String.valueOf(jscode) + "<img style=\"cursor: hand\" onclick=\"uploadimg5()\" src=\"/pianotrainwebstie/js/nopic.jpg\" id=txt5 height=\"" + height + "\"/>";
    ...
    public static String fck(final int height, final String content) {
        ...
        jscode = String.valueOf(jscode) + "<script type=\"text/javascript\"  src=\"/pianotrainwebstie/fckeditor/fckeditor.js\"></script>";
        ...
        jscode = String.valueOf(jscode) + "of.BasePath=\"/pianotrainwebstie/fckeditor/\";";
